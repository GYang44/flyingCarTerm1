...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        self.set_home_position(float(lon), float(lat), 0)

        # Done: retrieve current global position
        #gl_position = self.global_position
 
        # Done: convert to current local position using global_to_local()
        start_local_position = global_to_local(self.global_position, self.global_home)
        print(start_local_position)
